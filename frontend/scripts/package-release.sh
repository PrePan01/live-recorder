...
DMG_PATH="$FRONTEND/src-tauri/target/release/bundle/dmg/Live Recorder_0.5.71_aarch64.dmg"
...
rm -f "$RELEASE/Live Recorder_0.5.71_aarch64.dmg"
cp "$DMG_PATH" "$RELEASE/"

echo "[package-release] 完成 ✅"
echo "  .app: $RELEASE/Live Recorder.app"
echo "  .dmg: $RELEASE/Live Recorder_0.5.71_aarch64.dmg"